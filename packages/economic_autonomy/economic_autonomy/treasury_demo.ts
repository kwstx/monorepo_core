...
async function runTreasuryDemo() {
    ...
    const agentAlphaBudget: AgentBudget = {
        id: 'b-alpha',
        agentId: 'agent-alpha',
    ...
    const agentBetaBudget: AgentBudget = {
        id: 'b-beta',
        agentId: 'agent-beta',
    ...
    const agentGammaBudget: AgentBudget = {
        id: 'b-gamma',
        agentId: 'agent-gamma',
