...
exports.ReputationAndSynergyModule = void 0;
/**
 ...
 */
class ReputationAndSynergyModule {
    history = [];
    agentScores = new Map();
    synergyLinks = new Map();
    /**
     ...
     */
    getTrustThreshold(agentId, budgetRequested) {
     ...
     */
    getSynergyMultiplier(agentA, agentB) {
     ...
     */
    validateCommitmentPriority(message) {
    ...
    updateAgentScore(agentId) {
        ...
        const globalScore = (historicalSuccessRate * 0.4 +
     ...
     */
    updateSynergy(agentA, agentB, compatibility) {
        const key = this.getSynergyKey(agentA, agentB);
...
exports.ReputationAndSynergyModule = ReputationAndSynergyModule;
