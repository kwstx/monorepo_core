...
export interface ResourceAllocation {
  ...
  unit: string; // e.g., "USD", "tokens", "vCPU-hours"
}
...
export interface BudgetRevision {
  revisionId: string;
  timestamp: Date;
  actorId: string; // Who made the revision (e.g., "human-admin", "autonomous-treasury")
  reason: string;
...
export interface AgentBudget {
  id: string; // Unique identifier for this budget record
  agentId: string; // The ID of the agent this budget belongs to
